...
return `Olá @${sender.split("@")[0]} aqui está as informações sobre ele(a):
–
Número da Lenda: 
 ${numerodn}
–
...
\t• ${prefix}numero-dono 5588994158969
...
–
*1.* Para adicionar o grupo na lista de aluguel registrado sem gerar o código que faz o registro automático e nescessário o dono está no grupo futuramente à ser registrado no aluguel, use: *${prefix}addrent 558894.../dias*.
—
