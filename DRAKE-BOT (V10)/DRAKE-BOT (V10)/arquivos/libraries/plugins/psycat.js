/* 
    ❓️ Função: Você prefere? 
    📃 Descrição: Uma brincadeira do bot, chamada "Você prefere?", com o objetivo de interagir o grupo aonde usa o comando.
    🏷 Desenvolvedor: Carlos Sousa
*/
