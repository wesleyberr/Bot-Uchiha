 ...
 static async videoToWebp (media) {
  ...
  static async writeExifImg(media, metadata) {
    ...
    if (metadata.id || metadata.pack || metadata.author || metadata.emojis) {
        ...
        const stickerInfo = {"sticker-pack-id": metadata.id || "𝐂𝐀𝐑𝐋𝚯𝐒_𝚩𝚯𝚻 𝑽9", "sticker-pack-name": metadata.pack || "", "sticker-pack-publisher": metadata.author || "", "emojis": metadata.emojis ? metadata.emojis : ["🤠"]};
